 ...
 */
package moduledefault.evaluationmetric.recall;

import moduledefault.evaluationmetric.precision.*;
 ...
 * @author evaristowb
 */
@ModuleAnnotation(name = "Recall")
@EvaluationMetricModuleAnnotation
public class RecallEvaluationMetricModule extends Observable implements EvaluationMetricModuleInterface {
