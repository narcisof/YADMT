...
//    }                                        
//
//    private void svrpXStateChanged(javax.swing.event.ChangeEvent evt) {                                   
//        vrpX = Double.valueOf(svrpX.getValue().toString());
//        repaint();
//    }                                  
//
//    private void svrpYStateChanged(javax.swing.event.ChangeEvent evt) {                                   
//        vrpY = Double.valueOf(svrpY.getValue().toString());
//        repaint();
//    }                                  
//
//    private void svrpZStateChanged(javax.swing.event.ChangeEvent evt) {                                   
//        vrpZ = Double.valueOf(svrpZ.getValue().toString());
//        repaint();
//    }                                  
//
//    private void spontoXStateChanged(javax.swing.event.ChangeEvent evt) {                                     
//        pontoX = Double.valueOf(spontoX.getValue().toString());
//        repaint();        // TODO add your handling code here:
//    }                                    
//
//    private void spontoYStateChanged(javax.swing.event.ChangeEvent evt) {                                     
//        pontoY = Double.valueOf(spontoY.getValue().toString());
//        repaint();
//    }                                    
//
//    private void spontoZStateChanged(javax.swing.event.ChangeEvent evt) {                                     
//        pontoZ = Double.valueOf(spontoZ.getValue().toString());
//        repaint();
//    }                                    
//
//    private void sdistanciaStateChanged(javax.swing.event.ChangeEvent evt) {                                        
