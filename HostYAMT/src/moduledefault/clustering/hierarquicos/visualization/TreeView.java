...
public class TreeView extends Display {
    ...
    public static final String TREE_CHI = "tree.xml";
    ...
    public TreeView(Tree t, String label) {
        ...
        treeLayout.setLayoutAnchor(new Point2D.Double(350, 30));
    ...
    // ------------------------------------------------------------------------
    /*
     * Metodo para criar arquivo XML na raiz do projeto.
     */
    public static void newTreeXML(String tree) {
        try {
            // Create file 
            FileWriter fstream = new FileWriter("tree.xml");
